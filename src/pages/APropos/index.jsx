...
import Paysage from "../../assets/paysage_2.png";
    ...
    return (
        <section className='a_propos'>
            ...
            <div className='a_propos__content'>
                ...
                ' />
                <Collapse title='Service' text={'Nos équipes se iennent à votre disposition pour vous fournir une expérience parfaite. n\'hésitez pas à nous contacter si vous avez la moidre question'}/>
